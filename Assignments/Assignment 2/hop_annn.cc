...
int nearest_id(int start_point, int max_hop, int* query_data, int tid){
...
int main(int argc,char** argv){
    ...
    for (int i = 0; i < Q; ++i) {
        ...
        queries[i].nearest_id = nearest_id(queries[i].start_point, queries[i].hop, queries[i].query_data, tid);
    }
