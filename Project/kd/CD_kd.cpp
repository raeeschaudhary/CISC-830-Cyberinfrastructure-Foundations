/**
 * @file nearest_neighbor_distance.cpp
 * @brief Calculate the Chamfer Distance between two point clouds using the nearest neighbor search method.
 */
 ...
 * @param cloud_source The source point cloud.
 * @param cloud_target The target point cloud.
 * @param K The number of nearest neighbors to search for.
 * @return The computed Chamfer Distance.
 */
float compute (pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_source, pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_target, int K)
{
  ...
  // Iterate over each point in the source cloud
...
int main(int argc, char** argv)
{
  ...
  // Compute Chamfer Distance with K=1
  float CD1, CD2, CD;
